...
public static class PutTrailEndpoint
{
    ...
    public static async Task<Results<NoContent, ValidationProblem>> Invoke(Guid trailId, TrailDTO trailDTO, TrailValidator validator, ITrailRepository repository, CancellationToken cancellationToken = default)
    {
